...
class WegoHotels
{
     ...
     * @return mixed
     */
    public function getLocations(string $query, string $lang = 'en', int $page = 1, int $per_page = 10)
    {
     ...
     * @return mixed
     */
    public function getDetails(string $search_id, string $hotel_id, string $currency = 'USD', string $lang = 'en')
    {
        return $this->http->get(
