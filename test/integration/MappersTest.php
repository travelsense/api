...
class MappersTest extends TestCase
{
    ...
    public function testBookingMapper()
    {
        ...
        // getBookingsTotal
        $this->assertEquals(['bookings_total' => 2, 'reward_total' => 0], $this->booking_mapper->getBookingsTotal($author_a->getId()));
        $this->assertEquals(['bookings_total' => 1, 'reward_total' => 0], $this->booking_mapper->getBookingsTotal($author_b->getId()));
